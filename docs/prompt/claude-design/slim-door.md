# Claude Design prompt — Slim doors
...
Build a procedural three.js model of a **minimal-sightline aluminium sliding door** for FourlinQ, a
uPVC and aluminium windows-and-doors fabricator in the Philippines.

Deliver it as `slim-door-model.js`, exporting `buildSlimDoor(opts)`.
