...
export const PUBLIC_ROUTE = [
  ...
  { name: "for-architects", path: "/for-architects", heading: "resources to specify" },
  { name: "warranty", path: "/warranty", heading: "10-year limited warranty" },
  { name: "care", path: "/care", heading: "Designed to outlast you" },
  ...
  { name: "brand", path: "/brand", heading: "European engineering" },
