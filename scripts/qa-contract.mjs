...
export const PUBLIC_ROUTE = [
  ...
  { name: "aluminium", path: "/aluminium", heading: "Explore FourlinQ's aluminium system names" },
  { name: "design-tool", path: "/design-tool", heading: "Sketch a window" },
  { name: "why-upvc", path: "/why-upvc", heading: "Why uPVC" },
  { name: "inspiration", path: "/inspiration", heading: "Published project archive" },
  { name: "whats-new", path: "/whats-new", heading: "From the workshop" },
  { name: "for-architects", path: "/for-architects", heading: "Start a technical request" },
