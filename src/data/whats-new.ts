...
export const whatsNew: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    date: "2025-10-15",
    category: "product",
    title: "Eleven finish options across every system",
    excerpt: "From classic White to Wood Gray, Walnut, and Golden Oak — every FourlinQ system available in eleven brochure-verified finishes.",
